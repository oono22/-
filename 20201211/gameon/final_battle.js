...
window.onload = function() {
	...
	game.preload('play2.png','gamefl2.png','boss.png','i_acg1_1.png',
	...
	var sky = new Sprite(940,640);
        sky.image = game.assets['gamefl2.png'];
        sky.x = 0;
        sky.y = 0;
	...
	var tekiSprite = new Sprite(300,270);
		tekiSprite.x = 100;
		tekiSprite.y = 200;
		tekiSprite.image = game.assets['boss.png'];
